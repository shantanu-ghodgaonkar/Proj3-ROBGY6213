...
yBa = savedStates(14,:);
zBa = savedStates(15,:);
path = 'I:\My Drive\Academics\NYUMSMRSPRING24\Robot Localization and Navigation (ROB-GY 6213)\Project\Project3\LaTeX\img\plots\part1\';
dnum = ['dataset', int2str(datasetName)];
